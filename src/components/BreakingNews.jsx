const BreakingNews = () => {
  return (
    <div className="mx-[10%] my-6 h-12 glass-panel rounded-2xl flex items-center overflow-hidden shadow-premium border border-slate-200/40 dark:border-slate-800/30">
      {/* Fixed Left Section */}
      ...
      <div className="flex-1 overflow-hidden">
        <div className="flex items-center whitespace-nowrap animate-marquee gap-12">
          <div className="flex items-center gap-6">
            <p className="text-slate-600 dark:text-slate-300 text-[12px] font-semibold">
