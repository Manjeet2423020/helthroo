...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full px-[10%] h-20 glass-nav flex items-center justify-between shadow-premium transition-colors duration-300">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Language pill */}
        <div className="flex overflow-hidden rounded-full border border-slate-200/50 dark:border-slate-800/50 bg-white/20 dark:bg-slate-900/40 p-0.5">
          <button className="px-3.5 h-7 rounded-full bg-white dark:bg-slate-800 text-brand-cyan dark:text-brand-mint font-black text-[10px] shadow-sm transition-all duration-200">
            EN
          </button>
