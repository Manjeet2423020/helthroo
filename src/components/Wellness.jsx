          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-wider shrink-0 transition-all duration-300 border cursor-pointer ${
              activeTab === tab
                ...
                : "bg-white/20 dark:bg-slate-900/35 text-slate-500 dark:text-slate-400 border-slate-200/50 dark:border-slate-800/85 hover:bg-white/40 dark:hover:bg-slate-800/50 hover:text-slate-800 dark:hover:text-slate-200"
            }`}
          >
            {tab}
          </button>
